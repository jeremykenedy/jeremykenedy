<p align="center">
  <picture>
    ...
    <img src="art/banner-light.svg" alt="Jeremy Kenedy. Engineering leader, architect, and hands-on builder." width="800">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="art/impact-light.svg" alt="Open source adoption: package downloads, GitHub stars, community forks, and published packages. Exact totals follow." width="800">
  </picture>
</p>
...
<p align="center">
  <a href="https://github.com/jeremykenedy/ai-platform"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-ai-platform-dark.svg"><img src="art/project-ai-platform-light.svg" alt="AI Platform: self-hosted inference, persistent memory, and real-time conversations. Vue, PostgreSQL, Redis, Docker." width="392"></picture></a>
  <a href="https://github.com/jeremykenedy/PandaVentOS"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-PandaVentOS-dark.svg"><img src="art/project-PandaVentOS-light.svg" alt="PandaVentOS: open ESP32 firmware, printer telemetry, and a web interface in 24 languages." width="392"></picture></a>
</p>
<p align="center">
  <a href="https://github.com/jeremykenedy/claude-rules-mcp-server"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-claude-rules-mcp-server-dark.svg"><img src="art/project-claude-rules-mcp-server-light.svg" alt="MCP Developer Tooling: TypeScript and Node.js server for searchable engineering rules over HTTP and stdio." width="392"></picture></a>
  <a href="https://github.com/jeremykenedy/laravel-auth"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-laravel-auth-dark.svg"><img src="art/project-laravel-auth-light.svg" alt="Application Foundations: laravel-auth, with authentication, social sign-in, account recovery, and user management." width="392"></picture></a>
</p>
<p align="center">
  <a href="https://github.com/jeremykenedy/laravel-roles"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-laravel-roles-dark.svg"><img src="art/project-laravel-roles-light.svg" alt="Access Control: laravel-roles, reusable roles and permissions with a management interface." width="392"></picture></a>
  <a href="https://github.com/jeremykenedy/laravel-logger"><picture><source media="(prefers-color-scheme: dark)" srcset="art/project-laravel-logger-dark.svg"><img src="art/project-laravel-logger-light.svg" alt="Application Observability: laravel-logger, activity logging, configurable events, and an investigation dashboard." width="392"></picture></a>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="art/languages-light.svg" alt="Primary languages across original public repositories. Full language counts are available in the metrics snapshot." width="800">
  </picture>
</p>
